...
Ext.define('Restful.view.PortalPanel', {
    ...
    requires: [
        ...
        'Restful.view.PortalDropZone',
        'Restful.view.PortalColumn'
    ],
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('Restful.view.PortalDropZone', this, this.dropConfig);
    },
